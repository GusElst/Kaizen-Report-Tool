...
export const MobileNav = ({ open, onClose }: MobileNavProps) => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-72 flex-col bg-surface-300 border-r border-white/5 transition-transform duration-300 ease-in-out lg:hidden ${
      ...
      >
        ...
        <div className="border-t border-white/10 px-4 py-4">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-500 text-xs font-bold text-white font-heading">K</div>
