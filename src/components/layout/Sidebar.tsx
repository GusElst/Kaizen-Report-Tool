...
import {
  LayoutDashboard, Users, FileText, Layout, Settings, ChevronRight, LogOut,
} from 'lucide-react'
  ...
  return (
    <aside className="flex h-screen w-64 flex-col bg-surface-300 border-r border-white/5">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        <KaizenLogoIcon />
        <div>
          <p className="font-heading text-sm font-bold leading-tight text-white tracking-wide uppercase">Kaizen</p>
